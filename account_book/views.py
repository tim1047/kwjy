...
class MyAsset(APIView):
    ...
    def delete(self, request):
        ...
        try:
            result_data = main_account_book_service.delete_my_asset(request.data)
        except Exception as e:
            result_message = 'FAIL'
            result_data = {}
            exc_info = sys.exc_info()
...
class MyAssetAccum(APIView):
    def get(self, request):
        ...
        try:
            ...
            result_data = main_account_book_service.get_my_asset_accum(param)
        except Exception as e:
            result_message = 'FAIL'
            result_data = {}
            exc_info = sys.exc_info()
    ...
    def post(self, request):
        ...
        try:
            result_data = main_account_book_service.insert_my_asset_accum(request.data)
        except Exception as e:
            result_message = 'FAIL'
            result_data = {}
            exc_info = sys.exc_info()
